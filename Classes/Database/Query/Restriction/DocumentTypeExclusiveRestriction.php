...
namespace Xima\XimaTypo3Manual\Database\Query\Restriction;
 ...
 */
class DocumentTypeExclusiveRestriction implements QueryRestrictionInterface
{
    /**
     * @var int[]
     */
    ...
    public function buildExpression(array $queriedTables, ExpressionBuilder $expressionBuilder): CompositeExpression
    {
        ...
        foreach ($queriedTables as $tableAlias => $tableName) {
            ...
            $constraints[] = $expressionBuilder->in($tableAlias . '.doktype', $this->doktypes);
        }
